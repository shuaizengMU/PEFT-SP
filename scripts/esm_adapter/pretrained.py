...
import esm_adapter
from esm_adapter.model.esm2 import ESM2
...
def _load_model_and_alphabet_core_v1(model_data):
    import esm  # since esm_adapter.inverse_folding is imported below, you actually have to re-import esm here

    alphabet = esm_adapter.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = esm_adapter.ProteinBertModel
        ...
        model_type = esm_adapter.MSATransformer

    elif "invariant_gvp" in model_data["args"].arch:
        import esm_adapter.inverse_folding

        model_type = esm_adapter.inverse_folding.gvp_transformer.GVPTransformerModel
...
def _load_model_and_alphabet_core_v2(model_data, num_end_adapter_layers=None):
    ...
    alphabet = esm_adapter.data.Alphabet.from_architecture("ESM-1b")
    model = ESM2(
...
def esm_msa1_t12_100M_UR50S():
    warnings.warn(
        ...
        "please use ESM-MSA-1b: esm_adapter.pretrained.esm_msa1b_t12_100M_UR50S()",
    )
...
def esmfold_v0():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_v0()
...
def esmfold_v1():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_v1()
...
def esmfold_structure_module_only_8M():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_8M()
...
def esmfold_structure_module_only_8M_270K():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_8M_270K()
...
def esmfold_structure_module_only_35M():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_35M()
...
def esmfold_structure_module_only_35M_270K():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_35M_270K()
...
def esmfold_structure_module_only_150M():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_150M()
...
def esmfold_structure_module_only_150M_270K():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_150M_270K()
...
def esmfold_structure_module_only_650M():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_650M()
...
def esmfold_structure_module_only_650M_270K():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_650M_270K()
...
def esmfold_structure_module_only_3B():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_3B()
...
def esmfold_structure_module_only_3B_270K():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_3B_270K()
...
def esmfold_structure_module_only_15B():
    ...
    """
    import esm_adapter.esmfold.v1.pretrained
    return esm_adapter.esmfold.v1.pretrained.esmfold_structure_module_only_15B()
